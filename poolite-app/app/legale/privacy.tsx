      ...
      sections={[
        ...
        },
        {
          ...
          body: [
            ...
            'Dati di pagamento: gestiti direttamente da Stripe. Noi riceviamo solo l’esito e gli ultimi 4 numeri della carta, mai il numero completo né il CVV.',
        ...
        },
        {
          ...
          body: [
            ...
            'Pagamenti: Stripe, titolare autonomo per i dati di pagamento (comprese le transazioni Apple Pay e Google Pay).',
